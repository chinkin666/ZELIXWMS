...
const navItems = [
  ...
  { label: '業績レポート', sublabel: '荷主別・回転率', path: '/reports', keywords: 'report BI 業績 レポート 报表 荷主 回転率 turnover' },
  { label: '請求ダッシュボード', sublabel: '3PL課金', path: '/billing/dashboard', keywords: 'billing 請求 课金 3PL' },
  { label: 'FBAプラン', sublabel: 'Amazon FBA', path: '/fba/plans', keywords: 'fba amazon fulfilment' },
  { label: 'RSLプラン', sublabel: '楽天RSL', path: '/rsl/plans', keywords: 'rsl rakuten 楽天' },
