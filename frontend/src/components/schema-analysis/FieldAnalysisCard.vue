          ...
          <div class="examples-section">
            ...
            <div class="examples-list">
              <span
                ...
                :key="idx"
                class="o-badge o-badge-info example-tag clickable"
...
.ratio-label.filled { color: #409eff; }
.ratio-label.empty { color: #909399; }
.ratio-text { font-size: 12px; }
.empty-text { color: #909399; }
.full-text { color: #67c23a; }
...
.stacked-segment.clickable:hover { filter: brightness(1.1); }
.example-tag.clickable:hover { transform: scale(1.05); }
</style>
