...
const summaryItems = computed(() => {
  ...
  return [
    ...
    { key: 'recipientPostalCode', label: 'お届け先郵便番号', value: o.recipient?.postalCode || '-' },
    ...
    { key: 'senderAddress', label: 'ご依頼主住所', value: [o.sender?.prefecture, o.sender?.city, o.sender?.street, (o.sender as any)?.building].filter(Boolean).join(' ') || '-' },
    ...
    { key: 'ordererAddress', label: '注文者住所', value: [o.orderer?.prefecture, o.orderer?.city, o.orderer?.street, (o.orderer as any)?.building].filter(Boolean).join(' ') || '-' },
  ]
})
