      ...
      children: [
        ...
        // === 出荷管理（统一）/ 出荷管理（統合） ===
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import('@/views/shipment-orders/OrderCorrection.vue'),
              meta: { title: '受注訂正', requiresAuth: true },
            },
            {
              path: 'picking-list',
              name: 'PickingListPrint',
              component: () => import('@/views/shipment-operations/PickingListPrint.vue'),
              meta: { title: 'ピッキングリスト', requiresAuth: true },
            },
            {
              path: 'tracking',
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'sizes',
              name: 'InboundSizeRegister',
              component: () => import('@/views/inbound/InboundSizeRegister.vue'),
              meta: { title: 'サイズ登録', requiresAuth: true },
            },
            {
              path: 'billing',
              name: 'InboundBillingView',
              component: () => import('@/views/inbound/InboundBillingView.vue'),
              meta: { title: '入庫請求', requiresAuth: true },
            },
            {
              path: 'photos',
              name: 'InboundPhotoUpload',
              component: () => import('@/views/inbound/InboundPhotoUpload.vue'),
              meta: { title: '写真登録', requiresAuth: true },
            },
          ],
        },
        {
          ...
          children: [
            ...
            {
              path: 'ledger-view',
              name: 'InventoryLedgerView',
              component: () => import('@/views/inventory/InventoryLedgerView.vue'),
              meta: { title: '受払一覧', requiresAuth: true },
            },
            {
              path: 'replenishment-approval',
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: 'billing',
              name: 'ReturnBilling',
              component: () => import('@/views/returns/ReturnBilling.vue'),
              meta: { title: '返品請求', requiresAuth: true },
            },
          ],
        },
        {
        ...
        // === 請求管理 / 請求管理 ===
        {
          ...
          children: [
            ...
            },
            {
              path: 'storage',
              name: 'StorageBilling',
              component: () => import('@/views/billing/StorageBilling.vue'),
              meta: { title: '保管料', requiresAuth: true },
            },
          ],
        },
        // 業績レポート / 业绩报表
