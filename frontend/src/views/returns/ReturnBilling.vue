<template>
  <div class="return-billing">
    <PageHeader :title="t('wms.returns.billing', '返品請求')" :show-search="false" />
...
const loadBilling = async () => {
  try {
    ...
    const res = await apiFetch(`${getApiBaseUrl()}/billing/work-charges?category=return&year=${year}&month=${month}`)
